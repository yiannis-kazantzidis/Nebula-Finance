...
local function shouldAcceptInput()
    -- don't process input during non-main renderpass 084c13fd9ab5e54c15b80563b4dedd1ec4c267e51dc859efb9bc96e69941d3d4
...
local function drawDeveloperInfo()
    ...
    if IsValid(ent.csModel) then
        ent.csModel:SetSubMaterial(3, "!cryptoatm_machinescreenmat_"..ent:EntIndex())
    end
